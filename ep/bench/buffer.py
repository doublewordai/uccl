...
class Buffer:
    ...
    def get_dispatch_config(num_ranks: int) -> Config:
        ...
        config_map = {
            ...
            16: Config(Buffer.num_sms, 36, 288, 32 if os.getenv("UCCL_EP_TRANSPORT") == "cxi" else 20, 512 if Buffer._is_efa() else 128),
    ...
    def get_combine_config(num_ranks: int) -> Config:
        ...
        config_map = {
            ...
            16: Config(Buffer.num_sms, 4, 288, 32 if os.getenv("UCCL_EP_TRANSPORT") == "cxi" else 12, 512 if Buffer._is_efa() else 128),
