...
class Buffer {
 public:
  ...
  internode_prepare(std::uintptr_t num_tokens_per_rank_ptr,
                    ...
                    std::uintptr_t recv_expert_counts_ptr,
                    uccl::Config const& config,
    ...
    *moe_recv_rdma_counter = -1;
    ...
    uccl::internode::notify_dispatch(
        ...
        recv_expert_counts_ptr == 0
            ? nullptr
            : reinterpret_cast<int*>(recv_expert_counts_ptr),
        num_experts,
  ...
  std::optional<EventHandle> internode_combine(
      ...
      std::uintptr_t gbl_channel_prefix_matrix_ptr,
      std::uintptr_t gbl_rank_prefix_sum_ptr,
    ...
    uccl::internode::combine(
        ...
        reinterpret_cast<int const*>(rdma_rank_prefix_sum_ptr),
        reinterpret_cast<int const*>(gbl_channel_prefix_matrix_ptr),
        reinterpret_cast<int const*>(gbl_rank_prefix_sum_ptr), num_tokens,
  ...
  void compact_dispatch(std::uintptr_t x, std::uintptr_t ids,
                        std::uintptr_t weights, int tokens,
                        std::uintptr_t output_q, std::uintptr_t output_scales,
                        std::uintptr_t output_ids, std::uintptr_t output_weights,
    ...
    uccl::internode_ll::compact_dispatch(layout, reinterpret_cast<void const*>(x),
      ...
      reinterpret_cast<int64_t*>(output_ids), reinterpret_cast<float*>(output_weights),
      tokens, compact_capacity, compact_hidden, compact_topk, compact_experts,
      rank, num_ranks, max_nvl_peers, d_ipc_rdma_base_ptrs, reinterpret_cast<cudaStream_t>(stream_ptr));
  }
      ...
      .def(
          ...
          [](Buffer& self, std::uintptr_t num_tokens_per_rank_ptr,
            ...
            return self.internode_prepare(
                ...
                expert_alignment, num_worst_tokens,
                recv_expert_counts_ptr, config,
      ...
      .def(
          ...
          [](Buffer& self, std::uintptr_t x_ptr, int num_tokens, int hidden,
            ...
            return self.internode_combine(
                ...
                gbl_rank_prefix_sum_ptr, combined_rdma_head_ptr,
                combined_nvl_head_ptr, config,
          ...
          nb::arg("gbl_channel_prefix_matrix_ptr"),
          nb::arg("gbl_rank_prefix_sum_ptr"),
